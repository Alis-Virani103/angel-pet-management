...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header
      className={`fixed top-0 right-0 z-20 h-16 bg-white/90 backdrop-blur-md border-b border-slate-200 transition-all duration-300 flex items-center justify-between px-6 ${
    ...
    >
      ...
      <form onSubmit={handleSearchSubmit} className="relative w-80">
        ...
        <input
          ...
          className="w-full pl-9 pr-4 py-2 bg-slate-100 hover:bg-slate-100/80 focus:bg-white text-xs font-medium text-slate-800 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
        />
      </form>
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center space-x-1.5 px-3.5 py-2 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-medium text-xs shadow-sm shadow-blue-500/30 transition-colors"
          >
